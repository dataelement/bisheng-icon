...
<path fillRule="evenodd" clipRule="evenodd" d="M9.5 11H13.5C14.0523 11 14.5 11.4477 14.5 12V13.9975C14.5 14.5496 14.0527 14.9972 13.5006 14.9975L10.5032 14.9994C9.95103 14.9997 9.50307 14.5524 9.50259 14.0002L9.5 11Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M9.5 14.5V17" stroke="currentColor" strokeLinecap="round"/>
    </svg>
  )
);
