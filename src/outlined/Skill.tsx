...
const Skill = forwardRef<SVGSVGElement, IconProps>(
  ({ size = 24, color = 'currentColor', strokeWidth = 2, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M19 17V5C19 4.46957 18.7893 3.96086 18.4142 3.58579C18.0391 3.21071 17.5304 3 17 3H4" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M16.1141 10.376C14.3469 7.97923 12.2072 5.85483 11.1976 6.52214C10.1881 7.19017 12.3711 11.9769 11.9884 12.7778C11.6057 13.5788 10.0094 12.3116 9.42425 11.0248" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
);
